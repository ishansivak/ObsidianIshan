...
## Research Areas
- **Substrate Monitoring**: Using the [[Soil Moisture Sensor Node]] to measure substrate moisture in mushroom cultivation.
- **Growth Tracking**: Utilizing the [[Pest Detection Camera Node]] to observe mycelial development and detect contamination (molds, bacteria).
- **Communication Protocols**: Implementing [[Reticulum]] or [[Meshtastic]] to connect remote cultivation sites where traditional internet is unavailable.
